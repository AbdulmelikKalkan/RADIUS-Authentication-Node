 ...
 * @since AM 5.5.0
 */
public class RadiusNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(RadiusNodePlugin.currentVersion, 
				Collections.singletonList(RadiusNode.class));
	}
	...
	public String getPluginVersion() {
		return RadiusNodePlugin.currentVersion;
	}
}
